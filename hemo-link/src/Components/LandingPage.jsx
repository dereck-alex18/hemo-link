  ...
  return (
    <Box fontFamily="Arial, sans-serif" p={4}>
      ...
      <Box w="100%" border="5px solid darkgray" overflow="hidden" my={4} borderRadius="md">
        <Image src="public/images/img1.jpg" alt="Imagem de Cabeçalho" w="100%" h="auto" />
      </Box>
      ...
      >
        ...
        <Box flex="1" maxW="400px">
          <Image src="public/images/img2.jpg" alt="Imagem de apoio" w="100%" h="auto" borderRadius="md" />
        </Box>
      </Flex>
      ...
      <VStack spacing={4} align="center" my={4} px={[2, 4, 8]}>
        ...
        <Stack direction={['column', 'column', 'row']} align="center" spacing={[4, 6, 8]} w="100%" maxW="1000px">
          ...
          <Box flex="1" maxW="400px">
            <Image src="public/images/img3.jpg" alt="Imagem de apoio" w="100%" h="auto" borderRadius="md" />
          </Box>
        </Stack>
        <Button
      ...
      <VStack spacing={4} align="center" my={4} px={[2, 4, 8]}>
        ...
        <Flex direction={['column', 'row']} justifyContent="space-between" w="100%" maxW="800px">
          <Box flex="1" mb={[4, 0]} mr={[0, 4]} maxW="400px">
            <Image src="public/images/img4.jpg" alt="Imagem de apoio" w="100%" h="auto" borderRadius="md" />
          </Box>
